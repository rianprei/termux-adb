...
- **Módulo Magisk de porta fixa** — publicado em repo dedicado [rianprei/termux-adb-magisk-rootport](https://github.com/rianprei/termux-adb-magisk-rootport) (v1.0, testado ao vivo em 2 reboots reais): porta 5555 fixa no boot (post-fs-data), setprop → fallback resetprop.
